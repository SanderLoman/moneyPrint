...
const { ETH_ABI, BNB_ABI, GOE_ABI } = require("./constants.js")
...
const ETH_CONTRACT_ABI = ETH_ABI
const BNB_CONTRACT_ABI = BNB_ABI
const GOE_CONTRACT_ABI = GOE_ABI
...
const main = async () => {
    ...
    ethAddresses.on("Transfer", (from, to, amount, data) => {
        //if an address from the array addresses trades an alt coin for ETH, then log that data in the console
        if (addresses.includes(from)) {
            console.log(`${nameETH} transfer from: ${from} to: ${to} amount: ${amount} data: ${data}`)
    ...
    bnbAddresses.on("Transfer", (from, to, amount, data) => {
        //if an address from the array addresses trades an alt coin for BNB, then log that data in the console
        if (addresses.includes(from)) {
            console.log(`${nameBNB} transfer from: ${from} to: ${to} amount: ${amount} data: ${data}`)
    ...
    goeAddresses.on("Transfer", (from, to, amount, data) => {
        ...
        if (addresses.includes(from)) {
            console.log(`${nameGOE} transfer from: ${from} to: ${to} amount: ${amount} data: ${data}`)
